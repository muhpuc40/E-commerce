<header class="header-area header-sticky text-center header-default">
	...
	<div class="container">
		...
		<div class="ttheader-mail"><a href="mailto:mdhassan49.muh@gmail.com">mdhassan49.muh@gmail.com</a></div>
		</div>
	</div>
	</div>
            ...
            <div class="header-left float-left d-flex d-lg-flex d-md-block d-xs-block">
				...
				<button type="button" class="btn text-capitalize dropdown-toggle"><img src="img/banner/en.png" alt="en" height="12" width="18"/><span>English</span></button>
					...
					<ul>
								...
								<li><img src="img/banner/bn.png" alt="fr" width="18" height="12"/><span>বাংলা</span></li>
					</ul>
					</div>
				</div>
				<div class="currency-wrapper toggle">
				<button type="button" class="btn text-capitalize dropdown-toggle"><span>৳ TK</span></button>
				  ...
				  <div class="contact">
						...
						<a href="tel:0181813025">+880181813025</a>
				  </div>
			</div>
	...
	<div class="container">
		...
		<a class="nav-link dropdown-toggle text-uppercase" href="category.php">Shop</a>
		<div class="dropdown-menu mega-menu v-2 z-depth-1 special-color py-3 px-3">
		  <div class="row">
			<div class="col-md-12 col-xl-4 sub-menu mb-xl-0 mb-4">
			  <h6 class="sub-title text-uppercase font-weight-bold white-text">MAN</h6>
			  <!--Featured image-->
			...
			<div class="col-md-6 col-xl-4 sub-menu mb-md-0 mb-4">
			  <h6 class="sub-title text-uppercase font-weight-bold white-text">WOMEN</h6>
				<ul class="list-unstyled">
				<li>
		...
		<li class="nav-item ">
		<a class="nav-link  text-uppercase" href="about-us.php">
			about us
		  <span class="sr-only">(current)</span>        </a>

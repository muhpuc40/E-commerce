    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper"> <h2>All Customer List</h2>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table table-dark" id="dataTable">
                                ...
                                <tbody>
                                        <?php 
                                    $qry="SELECT * FROM customer_login";
                                    ...
                                    while($row=mysqli_fetch_array($r)){ ?>
                                            ...
                                            <td>
                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal1">Suspend</button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-danger" href="seller_delete.php?Did=<?php echo $row['id'] ?>">Yes</a>
        </div>
